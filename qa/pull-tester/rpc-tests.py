...
#Set env vars
buildDir = BUILDDIR
if "BINARIUMD" not in os.environ:
    os.environ["BINARIUMD"] = buildDir + '/src/binariumd' + EXEEXT
if "BINARIUMCLI" not in os.environ:
    os.environ["BINARIUMCLI"] = buildDir + '/src/binarium-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in Binarium Core
]

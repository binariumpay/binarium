...
Only requiring some minor changes is binarium.cpp.
...
Changes to binarium.cpp
----------------------
binarium.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

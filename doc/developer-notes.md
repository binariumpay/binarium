...
Binarium Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Binarium Core, where everyone uses
...
pay attention to for reviewers of Binarium Core code.

General Binarium Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Binarium Core uses tinyformat, which is type safe. Leave them out to avoid confusion

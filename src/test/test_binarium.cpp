...
#define BOOST_TEST_MODULE Binarium Test Suite

#include "test_binarium.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_binarium_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

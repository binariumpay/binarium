...
bool Intro::pickDataDirectory( bool _bSetDataDirFromGUI )
{
    namespace fs = boost::filesystem;
    QSettings settings;
        ...
        dataDirDefaultCurrent != dataDirDefaultSettings || _bSetDataDirFromGUI)
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Binarium Core"),
     ...
     * override -datadir in the binarium.conf file in the default data directory
     * (to be consistent with binariumd behavior)
     */

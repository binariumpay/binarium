    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Binarium Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Binarium Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  binarium-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Binarium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BINARIUM, 0.1 BINARIUM, 1 BINARIUM and 10 BINARIUM -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Binarium Core is shutting down...") + "<br /><br />" +

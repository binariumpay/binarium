    ...
    platformStyle(platformStyle)
{
    ...
    frameBlocks -> setProperty ( "class", "frameBlocks" );
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Binarium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Binarium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Binarium Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Binarium addresses to prove you own them"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Binarium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Binarium network", "", count));
    } else {
...
{
    QString strTitle = tr("Binarium Core"); // default title
    ...
    menu(0)
{
    ...
    setProperty ( "class", "UnitDisplayStatusBarControl" );
}

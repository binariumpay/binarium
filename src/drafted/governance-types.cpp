...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BinariumNetwork") type = BinariumNetwork;
    if(strType == "BinariumNetworkVariable") type = BinariumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BinariumNetwork) s = "BinariumNetwork";
    if(type == BinariumNetworkVariable) s = "BinariumNetworkVariable";

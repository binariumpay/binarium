 ...
 *
 *   // network
 *   CBinariumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CBinariumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBinariumNetwork(UniValue objIn)
    {
...
// // can be under: BinariumNetwork
// //   -- signature requirements : Key1(User)
// class CBinariumNetworkVariable : public CGovernanceObject
// {
// private:

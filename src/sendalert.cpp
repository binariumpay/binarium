...
2. run binariumd with -printalert or -sendalert like this:
   /path/to/binariumd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://binarium.money";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Binarium Core:0.12.0.58/"));

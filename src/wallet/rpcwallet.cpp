...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new Binarium address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"binariumaddress\"    (string) The new binarium address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current Binarium address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"binariumaddress\"   (string) The account binarium address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Binarium address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"binariumaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"binariumaddress\"  (string, required) The binarium address to be associated with an account.\n"
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Binarium address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"binariumaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"binariumaddress\"  (string, required) The binarium address for account lookup.\n"
            "\nResult:\n"
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"binariumaddress\"  (string) a binarium address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            "sendtoaddress \"binariumaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is use_ps )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"binariumaddress\" (string, required) The binarium address to send to.\n"
            ...
            "                             The recipient will receive less amount of Binarium than you enter in the amount field.\n"
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"binariumaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"binariumaddress\",     (string) The binarium address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"binariumaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"binariumaddress\"  (string, required) The binarium address to use for the private key.\n"
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "getreceivedbyaddress \"binariumaddress\" ( minconf addlockconf )\n"
            "\nReturns the total amount received by the given binariumaddress in transactions with specified minimum number of confirmations.\n"
            "\nArguments:\n"
            "1. \"binariumaddress\"  (string, required) The binarium address for transactions.\n"
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tobinariumaddress\" amount ( minconf addlockconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a binarium address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"    (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"tobinariumaddress\"  (string, required) The binarium address to send funds to.\n"
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The binarium address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less binariums than you enter in their corresponding amount field.\n"
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Binarium address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a Binarium address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of binarium addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) binarium address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"binariumaddress\"  (string) A binarium address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"binariumaddress\",  (string) The binarium address of the transaction. Not present for \n"
...
UniValue listtransactions_from_unix_time(const UniValue& params, bool fHelp)
{
    if (!EnsureWalletIsAvailable(fHelp))
        return NullUniValue;
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            "listtransactions    ( time count from includeWatchonly)\n"
            "\nReturns up to 'count' most recent transactions skipping the first 'from' transactions for account 'account'.\n"
            "\nArguments:\n"
            "1. time        (numeric, required) Unix time from which (including) to return the most recent transactions.\n"
            "2. count            (numeric, optional, default=10) The number of transactions to return\n"
            "3. from             (numeric, optional, default=0) The number of transactions to skip\n"
            "4. includeWatchonly (bool, optional, default=false) Include transactions to watchonly addresses (see 'importaddress')\n"
            "\nResult:\n"
            ...
            + HelpExampleCli("listtransactions", "") +
            "\nList transactions 100 to 120\n"
            + HelpExampleCli("listtransactions", "1516958200 20 100") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("listtransactions", "1516958200, 20, 100")
        );
...
UniValue listtransactions_for_addresses(const UniValue& params, bool fHelp)
{
    if (!EnsureWalletIsAvailable(fHelp))
        return NullUniValue;

    // listtransactions_for_addresses "*" 200 0 false "[\"XbCiEW3RpLyvuTBxf2Kn99bv6PrPB9Azy8\",\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\"]"
    // listtransactions_for_addresses "*" 2 0 "[\"XbCiEW3RpLyvuTBxf2Kn99bv6PrPB9Azy8\",\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\"]"
    // listtransactions_for_addresses 2 0 "[\"XbCiEW3RpLyvuTBxf2Kn99bv6PrPB9Azy8\",\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\"]"
    if (fHelp || params.size() < 3 || params.size() > 4)
        throw runtime_error(
            "listtransactions_for_addresses    ( \"account\" count from addresses includeWatchonly)\n"
            "\nReturns up to 'count' most recent transactions skipping the first 'from' transactions for account 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, required) DEPRECATED. The account name. Should be \"*\".\n"
            "2. count            (numeric, required, default=10) The number of transactions to return\n"
            "3. from             (numeric, required, default=0) The number of transactions to skip\n"
            "4. \"addresses\"      (string, required) A json array of binarium addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) binarium address\n"
            "      ,...\n"
            "    ]\n"
            "5. includeWatchonly (bool, optional, default=false) Include transactions to watchonly addresses (see 'importaddress')\n"
            "\nResult:\n"
            "[\n"
            "  {\n"
            "    \"account\":\"accountname\",  (string) DEPRECATED. The account name associated with the transaction. \n"
            ...
            "\nExamples:\n"
            "\nList the most recent 10 transactions in the systems\n"
            + HelpExampleCli("listtransactions", "10 0\"[\\\"XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwg\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"") +
            "\nList transactions 100 to 120\n"
            + HelpExampleCli("listtransactions", "20 100 \"[\\\"XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwg\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("listtransactions", "20, 100, \"[\\\"XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwg\\\",\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\"]\"")
        );
    ...
    set<CBitcoinAddress> setAddress;
    if (params.size() > 3) {
        //throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Addresses array: ")+params[3].getValStr ());
        UniValue inputs = params[3].get_array();
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            const UniValue& input = inputs[idx];
            CBitcoinAddress address(input.get_str());
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Binarium address: ")+input.get_str());
            if (setAddress.count(address))
    ...
    int nCount = 10;
    if (params.size() > 1) {
        //throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("nCount: ")+params[0].getValStr ());
        nCount = params[1].get_int();
    }
    int nFrom = 0;
    if (params.size() > 2) {
        //throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("nFrom: ")+params[1].getValStr ());
        nFrom = params[2].get_int();
    }
    isminefilter filter = ISMINE_SPENDABLE;
    if(params.size() > 4)
    ...
    bool bDoesTransactionContainsAtLeastOneAdressFromRequestedByUser;
    CTxDestination address;
    int i = 0;
    ...
    for (CWallet::TxItems::const_reverse_iterator it = txOrdered.rbegin(); it != txOrdered.rend(); ++it)
    {
        ...
        if (setAddress.size()) {
            bDoesTransactionContainsAtLeastOneAdressFromRequestedByUser = false;

            for ( i = 0; i < pwtx->vout.size (); i ++ ) {
                if ( ! ExtractDestination(pwtx->vout [ i ].scriptPubKey, address ) )
                    continue;

                //bDoesTransactionContainsAtLeastOneAdressFromRequestedByUser = bDoesTransactionContainsAtLeastOneAdressFromRequestedByUser ||
                //    setAddress.count(address) > 0;
                if ( setAddress.count(address) > 0 ) {
                    bDoesTransactionContainsAtLeastOneAdressFromRequestedByUser = true;
                    break;
                } //-if
            } //-for

            if ( ! bDoesTransactionContainsAtLeastOneAdressFromRequestedByUser ) {
                for ( i = 0; i < pwtx->vin.size (); i ++ ) {
                    if ( ! ExtractDestination(pwtx->vin [ i ].scriptSig, address ) )
                        continue;
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"binariumaddress\",  (string) The binarium address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"binariumaddress\",      (string) The binarium address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending binariums\n"
            "\nArguments:\n"
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending binarium\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"binariumaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "Wallet encrypted; Binarium Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending binariums.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of binarium addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) binarium address\n"
            "      ,...\n"
            "    ]\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the binarium address\n"
